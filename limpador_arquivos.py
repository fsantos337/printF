...
class LimpadorArquivos:
    ...
    def criar_interface(self):
        root = tk.Tk()
        root.title("PrintF - Limpar Arquivos")
        ...
        # Seleção de pasta - MODIFICAÇÃO AQUI
        ...
        self.entry_pasta = tk.Entry(frame_selecao, width=70)  # Aumentei o width
        self.entry_pasta.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 5))  # Usando fill e expand
